...
export const BasicCalculator: React.FC<BasicCalculatorProps> = ({ settings }) => {
  ...
  const btnClass = "h-14 font-semibold text-lg rounded-2xl transition-all duration-150 active:scale-95 active:translate-y-0.5 flex items-center justify-center shadow-xs select-none";
  ...
  return (
    <div className="max-w-md mx-auto w-full p-2 sm:p-4 flex flex-col gap-4">
      {/* Display Screen */}
      <div className={`${screenBg} border rounded-3xl p-5 flex flex-col justify-end min-h-[140px] text-right overflow-hidden relative group transition-colors shadow-lg`}>
      ...
      <div className="grid grid-cols-4 gap-2.5">
        <button onClick={handleClear} className={`${btnClass} bg-rose-500/15 hover:bg-rose-500/25 active:bg-rose-500/35 text-rose-500 border border-rose-500/30`}>
          C
        </button>
