    ...
    >
      <div className="flex items-center gap-3 min-w-0">
        ...
        <div className="min-w-0">
          <h2
            className={`text-sm sm:text-base font-bold flex items-center gap-2 truncate ${isLight ? 'text-slate-900' : 'text-slate-100'}`}
          >
            {modeInfo.title}
          </h2>
          <p
      ...
      <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
        ...
        >
          ...
          <kbd
            className={`hidden sm:inline px-1.5 py-0.5 rounded text-[10px] font-mono font-bold ${isLight ? 'bg-white border border-slate-300 text-slate-600' : 'bg-slate-950/60 border border-slate-700/80 text-slate-400'}`}
          >
            ⌘K
          </kbd>
        </button>
