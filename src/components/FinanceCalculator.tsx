  ...
  return (
    <div className="max-w-4xl mx-auto w-full p-4 flex flex-col gap-6">
      ...
      <div
        ...
        onKeyDown={(e) =>
          handleTablistKeydown(e, [...FINANCE_TABS], activeTab, (t) =>
            setActiveTab(t as FinanceTab)
          )
        }
      >
        {[
      ...
      <div
        role="tabpanel"
        id="fin-panel-emi"
        aria-labelledby="fin-tab-emi"
        tabIndex={0}
        hidden={activeTab !== 'emi'}
        className={activeTab !== 'emi' ? 'hidden' : 'grid grid-cols-1 md:grid-cols-2 gap-6'}
      >
      ...
      <div
        role="tabpanel"
        id="fin-panel-compound"
        aria-labelledby="fin-tab-compound"
        tabIndex={0}
        hidden={activeTab !== 'compound'}
        className={activeTab !== 'compound' ? 'hidden' : 'grid grid-cols-1 md:grid-cols-2 gap-6'}
      >
      ...
      <div
        role="tabpanel"
        id="fin-panel-gst"
        aria-labelledby="fin-tab-gst"
        tabIndex={0}
        hidden={activeTab !== 'gst'}
        className={
          activeTab !== 'gst'
            ? 'hidden'
            : 'max-w-xl mx-auto w-full bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-xl flex flex-col gap-5'
        }
      >
        <h3 className="text-sm font-bold text-slate-200 border-b border-slate-800 pb-3">
          GST & Tax Calculation
      ...
      <div
        role="tabpanel"
        id="fin-panel-discount"
        aria-labelledby="fin-tab-discount"
        tabIndex={0}
        hidden={activeTab !== 'discount'}
        className={
          activeTab !== 'discount'
            ? 'hidden'
            : 'max-w-xl mx-auto w-full bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-xl flex flex-col gap-5'
