...
export const CommandPalette: React.FC<CommandPaletteProps> = ({
  ...
  const commands: CommandItem[] = [
    ...
    },
    {
      ...
      subtitle:
        'Interactive Cartesian curves, roots, extrema, tangents, parameter sliders, and numerical tables',
      category: 'Engines & Calculators',
    ...
    },
    {
      ...
      subtitle:
        'Linear, polynomial, exponential, logarithmic, power fits, ANOVA statistics, residuals & inverse prediction',
      category: 'Engines & Calculators',
    ...
    },
    {
      ...
      subtitle:
        'Normal, Binomial, Poisson, Uniform, Exponential, Student t, Chi-Square PDF/CDF & quantiles',
      category: 'Engines & Calculators',
    ...
    },
    {
      ...
      subtitle:
        'Arithmetic, Geometric, Fibonacci, explicit f(n), recursive relations, partial sums & limits',
      category: 'Engines & Calculators',
    ...
    },
    {
      ...
      subtitle:
        'Rectangular a+bi, Polar r∠θ, Euler forms, Argand plane, n-th roots, and AC electrical phasors',
      category: 'Engines & Calculators',
    ...
    },
    {
      ...
      subtitle:
        "1/2-sample z/t-tests, ANOVA, Chi-Square tests, confidence intervals, effect sizes (Cohen's d, η²)",
      category: 'Engines & Calculators',
    ...
    },
    {
      ...
      subtitle:
        'SI dimensional analysis, compound physical unit evaluation, constants & interactive physics formulas',
      category: 'Engines & Calculators',
