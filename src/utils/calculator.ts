...
import { MAX_EXPRESSION_LENGTH, MAX_NESTING_DEPTH, MAX_EXPONENT } from '../constants/limits';
...
/**
 * Validates parsed MathJS AST against strict allowlists.
 ...
 * unknown symbols, and unapproved function calls.
 */
